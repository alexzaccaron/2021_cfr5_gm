...
for(i in 1:nrow(tab)){
  ...
  tab[i, 'flaking_size']      = median(flanking_interg_reg$size)
  tab[i, 'nonflaking_repeat'] = mean(nonflanking_interg_reg$cov.perc.repeats)
  tab[i, 'nonflaking_size']   = median(nonflanking_interg_reg$size)
}
#=================
...
#=================
pdf(plot1_fname, width = 6, height = 4)
...
#=================
pdf(plot2_fname, width = 6, height = 4)
